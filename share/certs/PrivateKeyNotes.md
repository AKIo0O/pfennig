...
unlocked to sign the AkiCoin-Qt.app bundle.
...
allowing somebody to distribute a AkiCoin-Qt.app or akicoin-qt-setup.exe with a valid
...
that the akicoin-qt.exe file inside the installer had not been tampered with.
