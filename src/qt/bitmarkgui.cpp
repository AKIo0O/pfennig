    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AkiCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitmarkGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AkiCoin address"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitmark"), tr("&About AkiCoin Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitmark_testnet"), tr("&About AkiCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about AkiCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AkiCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AkiCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AkiCoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the AkiCoin Core help message to get a list with possible Bitmark command-line options"));
...
void BitmarkGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("AkiCoin client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("AkiCoin client") + " " + tr("[testnet]"));
...
void BitmarkGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AkiCoin network", "", count));
}
...
{
    QString strTitle = tr("AkiCoin"); // default title
